...
public class VisualizarAnimalListaEspera extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_visualizar_animal_lista_espera);
            ...
            alerta.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        ClasseUtilitaria.emitirAlerta(VisualizarAnimalListaEspera.this, "Animal excluído com sucesso!");
                        irTelaVisualizarCliente();

                    } catch (Exception e) {
                        Toast.makeText(VisualizarAnimalListaEspera.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                }
            });
        ...
        public void irTelaEditarAnimal(View view) {
            Intent intent = new Intent(getApplicationContext(), EditarAnimalListaEspera.class);
            Bundle parametos = new Bundle();
            parametos.putInt("codigo_mutirao", codigoMutirao);
            parametos.putInt("codigo_cliente", codigoCliente);
